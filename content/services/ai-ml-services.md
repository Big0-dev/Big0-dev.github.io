...
evidence_items:
  - title: "Legal Document AI"
    desc: "AI system for UK law firms — reads, analyzes, and extracts insights from
      legal documents with accuracy matching senior associates."
    badge: "PLOS ONE Published"
    badge_color: green
    slug: "ai-legal-document-analysis-tool"
  - title: "FedGAN"
    desc: "Federated learning framework for privacy-preserving medical AI across
      hospitals. Published research, not a prototype."
    badge: "IEEE Published"
    badge_color: cyan
    slug: "fedgan"
  - title: "Real Estate Analytics"
    desc: "Market intelligence platform that processes property data into actionable
      investment insights."
    badge: "Production"
    badge_color: amber
    slug: "real_estate_analytics_case_study"
process_steps:
  - num: "01"
    title: "Assess"
...
faqs:
  - q: "How do you know AI is the right solution for my problem?"
    a: "Sometimes it isn't. We start every engagement with an honest assessment. If
      your problem is better solved with a simple database query or a process change,
      we'll tell you that — and save you the AI budget for where it actually matters."
  - q: "How long until we see results?"
    a: "A working prototype typically ships in 2-4 weeks. Production systems take
      2-6 months. You'll see demos every two weeks, so you're never waiting months
      to find out if the approach works."
  - q: "What about our existing systems?"
    a: "We integrate with what you already have. Our AI systems connect to your
      databases, your document management, your ERP — whatever your team uses today.
