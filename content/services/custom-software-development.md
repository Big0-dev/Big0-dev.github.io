...
capabilities:
  ...
  - title: "System Integration"
    desc: "Connect payment processors, document management, third-party APIs, and
      legacy databases. Clean APIs that work reliably."
    icon: link
    badge: "Reliable"
    badge_color: amber
  - title: "Legacy Modernization"
    desc: "Migrate your data, rebuild the parts that matter, keep operations running.
      No big-bang rewrites — incremental, working software."
    icon: refresh-cw
    badge: "Zero Downtime"
    badge_color: primary
evidence_items:
  - title: "Premium Finance Platform"
    desc: "Multi-party transaction platform replacing spreadsheet-based workflows
      for a UK premium finance company."
    badge: "Finance"
    badge_color: cyan
    slug: "premium-finance-management-platform"
  - title: "Healthcare Document System"
    desc: "Digital document management platform that replaced paper-based processes
      for a UK healthcare provider."
    badge: "Healthcare"
    badge_color: green
    slug: "firstclass-healthcare-document-management"
  - title: "Global Logistics Dashboard"
    desc: "Real-time visibility platform for international shipping operations across
